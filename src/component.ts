...
export class Component<P extends CProps<BaseComponentEventMap> = CProps<BaseComponentEventMap>, E extends BaseComponentEventMap = BaseComponentEventMap> extends BaseComponent<P, E> {
	...
	setContent(content: ComponentContent, refreshAll = true) {
	...
	protected _dispose(with_dom: boolean) {
	...
	public mapPropEvents(props: P, ...elements: string[]) {
	...
	static getElement<T extends Component>(dom: HTMLElement, classname?: Constructor<T> | string ): T {
...
export function flyWrap(dom: HTMLElement): Component {

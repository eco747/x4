...
function _getMetas( obj: object, create = true ) : MetaInfos {
	...
	let metas: MetaInfos = ctor[meta_name];
...
export function data_field( data: MetaData ) {
...
export function data_string( props?: MetaData ) {
...
export function data_int( props?: MetaData ) {
...
export function data_float( props?: MetaData ) {
...
export function data_bool( props?: MetaData ) {
...
export function data_date( props?: MetaData ) {
...
export function data_calc( props?: MetaData ) {
...
export function data_array( ctor: RecordConstructor, props?: MetaData  ) {
